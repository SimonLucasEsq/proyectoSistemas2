...
class AlumnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumno" do
    assert_difference('Alumno.count') do
      post alumnos_url, params: { alumno: { cant_horas: @alumno.cant_horas, carrera_id: @alumno.carrera_id, datos_personal_id: @alumno.datos_personal_id } }
    end
  ...
  test "should update alumno" do
    patch alumno_url(@alumno), params: { alumno: { cant_horas: @alumno.cant_horas, carrera_id: @alumno.carrera_id, datos_personal_id: @alumno.datos_personal_id } }
